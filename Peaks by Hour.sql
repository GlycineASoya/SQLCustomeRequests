...
select datepart(hour, insq.startdatetime) as 'Hour',
count(datepart(hour, insq.startdatetime)) as 'Total Calls',
...
group by datepart(hour, insq.startdatetime), datepart(hour, insq.startdatetime)